...
if(isset($_POST['add_category_btn']))
{
    ...
    if($cate_query_run)
    {
        ...
        redirect("category.php", "Student Added Successfully");
    ...
    $offense_type = mysqli_real_escape_string($con, $_POST['offense_type']); // New field
  
    $insert_query = "INSERT INTO categories (name, case_id, student_id, offense_id, offense_type) VALUES ('$name', '$case_id', '$student_id', '$offense_id', '$offense_type')";
    ...
    $offense_id = $_POST['offense_id'];
    $student_id = $_POST['student_id'];
    $offense_type = $_POST['offense_type']; // New field
    $last_updated = $_POST['last_updated'];
    $reported_by = $_POST['reported_by'];
    $date_of_offense = $_POST['date_of_offense'];
    $assigned_by = $_POST['assigned_by'];
    ...
    student_id='$student_id', offense_type='$offense_type', 
    last_updated='$last_updated', reported_by='$reported_by', date_of_offense='$date_of_offense', 
    assigned_by='$assigned_by', status='$status', popular='$popular', image='$update_filename' WHERE id='$category_id'";
...
else if(isset($_POST['update_punishment_btn']))
{
    ...
    if($update_query_run)
    {
        ...
        redirect("punishment.php?id=$category_id", "Punishment Upadated Successfully");
