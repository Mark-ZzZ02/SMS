                                ...
                                <div class="card-body">
                                    <form action="codeuser.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="password" class="form-control" placeholder="Enter new Password" id="exampleInputPassword1" value="<?= htmlspecialchars($data['password'], ENT_QUOTES) ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="role_as" class="form-control" id="role">
                                                <option value="1" <?= $data['role_as'] == 1 ? 'selected' : '' ?>>Approved (Admin)</option>
                                                <option value="2" <?= $data['role_as'] == 2 ? 'selected' : '' ?>>Approved (Staff)</option>
