                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%;">
                                                ...
                                                <input type="text" name="program" value="<?= $data['program'] ?>" class="form-control" readonly required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%;">
                                                <label for="section">SECTION</label>
                                                <input type="text" name="section" value="<?= $data['section'] ?>" class="form-control" readonly required>
                                            </td>
                                            <td style="width: 50%;">
                                                <label for="major">MAJOR</label>
                                                <input type="text" name="major" value="<?= $data['major'] ?>" class="form-control" readonly required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%;">
                                                <label for="sms_email">EMAIL</label>
                                                <input type="email" name="sms_email" value="<?= $data['sms_email'] ?>" class="form-control" readonly required>
                                            </td>
                                            <td style="width: 50%;">
                                                <label for="year_level">YEAR LEVEL</label>
                                                <input type="text" name="year_level" value="<?= $data['year_level'] ?>" class="form-control" readonly required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%;">
                                        ...
                                        <tr>
                                            <td style="width: 50%;">
                                                ...
                                                <input type="text" name="parent_name" value="<?= $data['parent_name'] ?>" placeholder="Enter Parent Name" class="form-control" >
                                            </td>
                                            <td style="width: 50%;">
                                                <label for="parent_contact">PARENT CONTACT</label>
                                                <input type="text" name="parent_contact" value="<?= $data['parent_contact'] ?>" placeholder="Enter Parent Contact" class="form-control" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%;">
                                                <label for="date_meeting">DATE MEETING</label>
                                                <input type="date" name="date_meeting" value="<?= $data['date_meeting'] ?>" class="form-control" >
                                            </td>
                                            <td style="width: 50%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%;">
                                                ...
                                                <input type="text" name="attendees" value="<?= $data['attendees'] ?>" placeholder="Enter Case Attendees" class="form-control" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%;">
